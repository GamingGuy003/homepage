        ...
        .child((
            ...
            progress()
                .class("
                    ...
                    [&::-webkit-progress-value]:bg-gradient-to-r [&::-webkit-progress-value]:from-terminal-orange [&::-webkit-progress-value]:to-terminal-red bg-background-ui
                    ...
                    dark:[&::-webkit-progress-value]:bg-gradient-to-r dark:[&::-webkit-progress-value]:from-terminal-azure-dark dark:[&::-webkit-progress-value]:to-terminal-purple-dark dark:bg-background-ui-dark"
                )
                .max(100)
